...
export default function ReportDetail() {
  ...
  const exportJSON = () => {
    ...
    a.download = `Nocturned-${report.report_id}.json`
    a.click()
  }
  ...
  const exportPDF = () => {
    ...
    doc.setFontSize(20)
    doc.text('Nocturned — Credit Report', 20, 20)
    ...
    doc.text('Generated by Nocturned — zero-knowledge credit scoring on Midnight blockchain', 20, 280)

    doc.save(`Nocturned-${report.report_id}.pdf`)
  ...
  const exportZKCert = () => {
    ...
    doc.text('Issued by Nocturned · Midnight Blockchain · Preprod Network', 20, 33)
    ...
    doc.text('Generated by Nocturned — confidential credit scoring powered by Midnight.', 20, 231)

    doc.save(`Nocturned-zk-cert-${report.report_id}.pdf`)
  ...
  const exportEncrypted = async () => {
    ...
    try {
      ...
      const a = document.createElement('a')
      a.href = URL.createObjectURL(blob)
      a.download = `Nocturned-${report.report_id}.enc.json`
      a.click()
